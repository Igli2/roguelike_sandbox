...
public abstract class Player extends Entity {
    ...
    public Player(SpriteBatch batch, World world, Vector2 position, int level, int vitality, int constitution, int strength, int dexterity, int intelligence, int luck, EntityTexture texture) {
