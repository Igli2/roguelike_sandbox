...
public class Wizard extends Player {
    ...
    public Wizard(SpriteBatch batch, TextureAtlas textureAtlas, RoguelikeWorld world, Vector2 position, int level) {
        super(batch, textureAtlas, world, position, level, 12, 8, 7, 6, 9, 3, EntityTexture.WIZARD);
    }

    public Wizard(SpriteBatch batch, TextureAtlas textureAtlas, RoguelikeWorld world, Vector2 position, int level, int vitality, int constitution, int strength, int dexterity, int intelligence, int luck, EntityTexture texture) {
